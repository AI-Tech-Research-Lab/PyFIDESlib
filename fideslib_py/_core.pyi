...
class CryptoContext:
    ...
    def AccumulateSumInPlace(self, ciphertext: Ciphertext, slots: int, stride: int = 1) -> None:
        ...
    def ClearAuxiliaryPolyPool(self) -> None:
        ...
    ...
    def EvalSubInPlace(self, arg0: Ciphertext, arg1: float) -> None:
        ...
    def GetAuxiliaryPolyPoolSize(self) -> int:
        ...
    def GetCiphertextCache(self) -> int | None:
        ...
    def GetCiphertextCacheResidentBytes(self) -> int:
        ...
    def GetCyclotomicOrder(self) -> int:
        ...
    def GetDeviceObjectCounts(self) -> dict:
        ...
    def GetPlaintextCache(self) -> int | None:
        ...
    def GetPlaintextCacheResidentBytes(self) -> int:
        ...
    def GetRingDimension(self) -> int:
        ...
    def GetRotationKeyCache(self) -> int | None:
        ...
    def GetRotationKeyCacheResidentBytes(self) -> int:
        ...
    def IsRotationKeyResident(self, index: int) -> bool:
        ...
    ...
    def MakeCKKSPackedPlaintextF64(self, value: numpy.ndarray[typing.Any, numpy.dtype[numpy.float64]], noiseScaleDeg: int = 1, level: int = 0, slots: int = 0) -> Plaintext:
        ...
    def OffloadCiphertexts(self) -> None:
        ...
    def OffloadPlaintexts(self) -> None:
        ...
    def OffloadRotationKeys(self, indexes: list[int] = []) -> None:
        ...
    def PinCiphertext(self, ciphertext: Ciphertext, pin: bool = True) -> None:
        ...
    def PinPlaintext(self, plaintext: Plaintext, pin: bool = True) -> None:
        ...
    def PinRotationKey(self, index: int, pin: bool = True) -> None:
        ...
    ...
    def SetAutoLoadPlaintexts(self, arg0: bool) -> None:
        ...
    def SetCiphertextCache(self, nbytes: int | None) -> None:
        ...
    def SetDevices(self, devices: list[int]) -> None:
        ...
    def SetPlaintextCache(self, nbytes: int | None) -> None:
        ...
    def SetRotationKeyCache(self, nbytes: int | None) -> None:
        ...
...
class Plaintext:
    ...
    def GetRealPackedValue(self) -> list[float]:
        ...
    def IsLoadedOnDevice(self) -> bool:
        ...
